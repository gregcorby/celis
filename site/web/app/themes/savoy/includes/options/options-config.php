<?php
	...
	Redux::setSection( $opt_name, array(
		...
		'fields'	=> array(
            ...
            array(
				...
				'type'			=> 'slider',
				'title'			=> __( 'Related Posts - Products per Page', 'nm-framework-admin' ),
	...
	Redux::setSection( $opt_name, array(
		...
		'fields'	=> array(
            ...
            array (
				...
				'icon'	=> true,
				'type'	=> 'info',
				'raw'	=> '<h3 style="margin: 0;">' . __( 'Product Image(s)', 'nm-framework-admin' ) . '</h3>',
			),
			array(
			...
			array (
				...
				'icon'	=> true,
				'type'	=> 'info',
				'raw'	=> '<h3 style="margin: 0;">' . __( 'Product Details', 'nm-framework-admin' ) . '</h3>',
			),
            array(
        ...
        Redux::setSection( $opt_name, array(
            ...
            'fields'	=> array(
                ...
                array(
                    ...
                    'type'		=> 'switch',
                    'title'		=> __( 'Filters', 'nm-framework-admin' ),
                    'desc'		=> __( 'Display portfolio-category filter menu.', 'nm-framework-admin' ),
                    'default'	=> 1,
                    'on'		=> 'Enable',
                    'off'		=> 'Disable'
                ),
                array(
                    'id'        => 'portfolio_filters_alignment',
                    'type'      => 'select',
                    'title'     => __( 'Filters Alignment', 'nm-framework-admin' ),
                    'desc'      => __( 'Select portfolio-category filters alignment.', 'nm-framework-admin' ),
                    'options'	=> array( 
                        'left'      => 'Left',
                        'center'    => 'Center',
				        'right'     => 'Right'
                    ...
                    'default'	=> 'left',
                    'required'	=> array( 'portfolio_filters', '=', '1' )
                ),
                array(
                    'id'		=> 'portfolio_items',
                    'type' 		=> 'text',
	...
	Redux::setSection( $opt_name, array(
		...
		'fields'	=> array(
			...
			array(
				...
				'type'		=> 'text',
				'title'		=> __( 'LinkedIn', 'nm-framework-admin' ),
            ...
            array(
				...
				'type'		=> 'text',
				'title'		=> __( 'Snapchat', 'nm-framework-admin' ),
				'desc'		=> __( 'Enter your Pinterest profile URL.', 'nm-framework-admin' ),
				'validate'	=> 'url',
				'default'	=> ''
			),
            array(
				...
				'type' 		=> 'text',
				'title' 	=> __( 'Behance', 'nm-framework-admin' ),
				'desc'		=> __( 'Enter your Behance profile URL.', 'nm-framework-admin' ),
				'validate'	=> 'url',
				'default'	=> ''
			),
			array(
	...
	if ( defined( 'WPCF7_VERSION' ) ) {
		Redux::setSection( $opt_name, array(
			'title'		=> __( 'CF7', 'nm-framework-admin' ),
			'icon'		=> 'el-icon-envelope',
			'fields'	=> array(
				array(
					'id'		=> 'cf7_pages',
					'type' 		=> 'text',
					'title' 	=> __( 'Form Pages', 'nm-framework-admin' ),
					'desc'		=> __( 'Prevent loading CF7 scripts on every page by entering id(s), title(s) or slug(s) to your form pages (separate with commas ",").', 'nm-framework-admin' ),
					'validate'	=> 'no_special_chars',
					'default'	=> ''
				)
			)
