...
function my_theme_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'            	=> NM_DIR . '/theme-plugins/js_composer.zip',	// The plugin source
		...
		array(
			...
			'source'   				=> NM_DIR . '/theme-plugins/envato-wordpress-toolkit-master.zip',
			'required' 				=> false,
			'version' 				=> '1.7.2',
			'force_activation' 		=> false,
			'force_deactivation' 	=> false,
		...
		/*array(
			...
			'slug'     				=> 'revslider',
			'source'   				=> NM_DIR . '/theme-plugins/revslider.zip',
			'required' 				=> false,
			'version' 				=> '5.2.6',
			'force_activation' 		=> false,
			'force_deactivation' 	=> false,
