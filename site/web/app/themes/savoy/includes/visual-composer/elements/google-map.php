	...
	vc_map( array(
	   ...
	   'params'			=> array(
           array(
            ...
            array(
				'type' 			=> 'textfield',
				'heading' 		=> __( 'Minimum Zoom Level', 'nm-framework-admin' ),
				'param_name' 	=> 'min_zoom',
				'description' 	=> __( 'Minimum map zoom level (1 - 20).', 'nm-framework-admin' ),
				'value' 		=> '1',
			),
			array(
				'type' 			=> 'checkbox',
            ...
            array(
				'type' 			=> 'textfield',
				'heading' 		=> __( 'API Key', 'nm-framework-admin' ),
				'param_name' 	=> 'api_key',
				'description'	=> __( 'If you want to use your own Google Maps API key, enter it above.', 'nm-framework-admin' )
			)
	   )
	) );
